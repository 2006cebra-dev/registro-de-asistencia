<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <span class="text-white">Editar Estudiante</span>
                <p class="text-sm font-normal text-gray-400">Modifica los datos del estudiante</p>
            </div>
        </div>
    </x-slot>
                    ...
                    <form action="{{ route('estudiantes.update', $estudiante) }}" method="POST">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="nombre" value="{{ old('nombre', $estudiante->nombre) }}" class="input-field @error('nombre') border-red-500 @enderror pl-10" required placeholder="Nombre completo del estudiante">
                            </div>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="relative">
                                ...
                                <input type="email" name="email" value="{{ old('email', $estudiante->email) }}" class="input-field @error('email') border-red-500 @enderror pl-10" required placeholder="correo@ejemplo.com">
                            </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                ...
                                <select name="curso_id" class="input-field @error('curso_id') border-red-500 @enderror pl-10" required>

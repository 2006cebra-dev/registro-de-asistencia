    ...
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-sm font-normal text-gray-300">Gestiona los cursos del sistema</p>
            </div>
        </div>
    </x-slot>
                        ...
                        <td class="px-4 py-3.5 text-center">
                            <div class="flex justify-center gap-1 opacity-70 hover:opacity-100 transition-opacity">
                                ...
                                <form action="{{ route('cursos.destroy', $curso) }}" method="POST" class="inline">
                                    @csrf @method('DELETE')
                                    <button type="submit" onclick="return confirm('¿Desactivar el curso {{ $curso->nombre }}? Los estudiantes no podrán registrar asistencia.')"
